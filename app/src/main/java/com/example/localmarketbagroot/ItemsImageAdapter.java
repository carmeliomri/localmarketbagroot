...
public class ItemsImageAdapter extends RecyclerView.Adapter<ItemsImageAdapter.ImageViewHolder> {
    ...
    public ItemsImageAdapter(Context context, List<String> imageUrls, OnImageClickListener listener) {
